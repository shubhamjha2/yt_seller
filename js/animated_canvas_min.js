...
//   var canvas = document.getElementById("hero_canvas1");
//   var ctx = document.getElementById("hero_canvas1").getContext("2d");
//   ctx.clearRect(0, 0, canvas.width, canvas.height);
//   ctx.save();
//   var randomX = random(0.2, 0.9);
//   var randomY = random(0.1, 0.2);
//   var rectX = Math.cos(time * 1) * 1.5 + randomX;
//   var rectY = Math.sin(time * 1) * 1.5 + randomY;
//   var rectX2 = Math.cos(time * 0.7) * 3 + randomX;
//   var rectY2 = Math.sin(time * 0.7) * 3 + randomY;
//   var rectX3 = Math.cos(time * 1.4) * 4 + randomX;
//   var rectY3 = Math.sin(time * 1.4) * 4 + randomY;
//   var triangle_gradient = ctx.createLinearGradient(
//     0,
//     0,
//     canvas.width,
//     canvas.height
